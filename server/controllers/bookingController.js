...
exports.getBookingsByUser = async (req, res) => {
  try {
    const bookings = await Booking.find({ user: req.params.userId }).populate("professional");
    res.json(bookings);
  } catch (error) {
...
exports.getBookingsByPro = async (req, res) => {
  try {
    const bookings = await Booking.find({ professional: req.params.proId }).populate("user");
    res.json(bookings);
  } catch (error) {
